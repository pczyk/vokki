...
public class Lections extends BaseController {
    ...
    private final Map<Lection, Long> numberOfWordsPerLection = new HashMap<>();
    ...
    public boolean isDiableLection(final Lection lection) {
        return getNumberOfWordsInLection(lection) == 0;
    }
    ...
    public void startExam(final Lection lection) {
        ...
        try {
            ...
            Logger.getLogger(Lections.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
